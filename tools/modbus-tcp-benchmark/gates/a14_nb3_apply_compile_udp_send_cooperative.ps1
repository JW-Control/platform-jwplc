...
if (-not $resumePatched) {
    $expectedPreHashes = [ordered]@{
        $dnsCppRelative = "3DE3CD1A14BD07C1FE3B0725941B2137A5109B43647AA3E10B3EF6A1E6EEC5F5"
        $dnsHeaderRelative = "EF6C5392C0CBFB8545BFF8EB4D30E3FEDAC005725DF292418A5CF974BE6F6FD2"
        $mainHeaderRelative = "3E11094D68873D81F264F8AD97C1D55867F5399E28613061BC38484CD7DE614B"
        $socketRelative = "EF450C75880A2427494585E8EB1C1E3FD62EC7B9562E37A3AA75C48761886104"
    }
