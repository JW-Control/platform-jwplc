...
Write-Host "============================================================"
Write-Host " A14 P3 - UDP RX INSTRUMENT ONLY @ 26 MHz"
Write-Host "============================================================"
...
Write-Host "ALGORITHM_CHANGE=NO"
...
$tempRoot = Join-Path $env:TEMP ("jwplc_a14_p3_udp_rx_{0}" -f $timestamp)
...
Write-Host ""
Write-Host "=== UDP RX INSTRUMENTATION RUNS ==="
...
Write-Host ""
Write-Host "A14_P3_ALGORITHM_CHANGE=NO"
Write-Host "A14_P3_PRODUCT_SOURCE_MUTATION=NO"
Write-Host "A14_P3_DIAGNOSTIC_COPY_ONLY=YES"
Write-Host "A14_P3_UDP_RX_INSTRUMENT_ONLY=PASS"
Write-Host "NEXT_ACTION=RETURN_OUTPUT_TO_CHAT_FOR_BOTTLENECK_ANALYSIS"
