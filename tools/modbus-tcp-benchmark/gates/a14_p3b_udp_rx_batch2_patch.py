...
def main() -> int:
    ...
    if not path.is_file():
        raise RuntimeError(f"P3B_SKETCH_NOT_FOUND={path}")
...
"""
    ...
    text = replace_once(
        ...
        old,
        new,
        "P3B_BATCH2_SERVICE_UDP",
    )

    path.write_text(text, encoding="utf-8", newline="\n")

    print("P3B_UDP_RX_MAX_PACKETS_PER_HOLD=2")
    print("P3B_OTHER_ALGORITHM_CHANGE=NO")
    print("P3B_BATCH2_PATCH=PASS")
    return 0
