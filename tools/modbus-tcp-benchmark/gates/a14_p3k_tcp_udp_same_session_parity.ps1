...
if ($Runs -ne 3) { throw "P3K_RUNS_MUST_BE_3_FOR_BALANCED_SEQUENCE" }
...
Write-Host "A14_P3K_UDP_CANDIDATE=BATCH2_INT_FUSED_COMMIT2_R1"
...
Write-Host "A14_P3K_SAME_SESSION_TCP_UDP_PARITY=PASS"
