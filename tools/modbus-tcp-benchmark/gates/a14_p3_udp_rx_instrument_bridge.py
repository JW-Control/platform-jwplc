"""P3 UDP RX instrumentation bridge over the frozen ETH14 raw runner."""
...
if not RUNNER_PATH.is_file():
    raise SystemExit(f"P3_RUNNER_NOT_FOUND={RUNNER_PATH}")

spec = importlib.util.spec_from_file_location(
    "eth14_raw_transport_benchmark_p3",
    RUNNER_PATH,
)

if spec is None or spec.loader is None:
    raise SystemExit("P3_RUNNER_IMPORT_SPEC_FAILED")
...
try:
    ...
    if exc.code is None:
        ...
        print(f"P3_RUNNER_SYSTEM_EXIT={exc.code}")
        exit_code = 1
finally:
    print()
    print("========================================")
    print(" P3 UDP RX FINAL SNAPSHOT")
    print("========================================")

    if _last_snapshot:
        print("P3_FINAL_SNAPSHOT_PRESENT=YES")
        for key in SNAPSHOT_KEYS:
            print(f"P3_FINAL_{key}={_last_snapshot.get(key, '')}")
    else:
        print("P3_FINAL_SNAPSHOT_PRESENT=NO")
