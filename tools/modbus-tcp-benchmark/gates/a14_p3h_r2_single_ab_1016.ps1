...
Write-Host "============================================================"
Write-Host " A14 P3H-R2 BLOCK - FUSED VS LEGACY @ 1016 B / 8x2KB / 26 MHz"
Write-Host "============================================================"
...
Write-Host "A14_P3H_R2_BLOCK_UDP_RX_FUSED_FAST_PATH_AB=PASS"
Write-Host "NEXT_ACTION=P3H_R2_REPEATABILITY_AGGREGATION"
