...
/* Macros para extraer la dirección del dispositivo y el índice del pin
   de un número de pin en formato de 16 bits:
	  - Los 8 bits superiores corresponden a la dirección I2C del dispositivo.
	  - Los 8 bits inferiores corresponden al índice de la E/S en ese dispositivo.
*/
