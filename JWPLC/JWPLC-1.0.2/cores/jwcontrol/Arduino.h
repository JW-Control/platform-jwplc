...
#define _IS_PINS_FUNCTIONS_DO_RETURN_INT
#include "jwplc-peripherals/include/jwplc-peripherals.h"

extern int retinitExpandedGPIO;
extern int retIS_initDefaultIOPins;
extern unsigned int IS_initDefaultIOPins_line;
