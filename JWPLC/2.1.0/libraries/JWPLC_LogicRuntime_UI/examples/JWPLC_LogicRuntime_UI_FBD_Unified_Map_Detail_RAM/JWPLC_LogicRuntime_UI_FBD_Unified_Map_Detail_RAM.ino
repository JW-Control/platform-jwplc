...
void setup()
{
  ...
  Serial.println();
  Serial.println("JWPLC Logic Runtime UI - Unified MAPA/DETALLE preview");
  Serial.println("Implementacion independiente: no hereda V4...V14.");
  Serial.println("Alcance: MAPA, DETALLE, navegacion, T/Ta y transiciones.");
  Serial.println("OK dentro de DETALLE no abre editores en este preview.");
  Serial.println("No escribe FRAM ni conmuta salidas Q fisicas.");
  Serial.println();
  ...
  Serial.println("Unified preview: ACTIVO");
...
void loop()
{
  ...
  if (phase != lastPhase)
  {
    ...
    Serial.print(" timing=");
    Serial.println(engine.tonTiming(7) ? 1 : 0);
  }
